...
EOF;
    ...
    */
     ...
     */
    private function admin_logic_1616123194()
    {
        $syn_admin_logic_1616123194 = tpSetting('syn.syn_admin_logic_1616123194', [], 'cn');
        if (empty($syn_admin_logic_1616123194)) {
            try{
                /*多语言*/
                if (is_language()) {
                ...
                /*--end*/
                tpSetting('syn', ['syn_admin_logic_1616123194'=>1], 'cn');
            }catch(\Exception $e){}
        }
    }
}
