...
class Index extends Base
{
    ...
    public function index()
    {
        ...
        if ($this->admin_lang == $this->main_lang) {
            $diyminipro_list = Db::name('weapp')->field('id,code,name')->where(['code'=>['IN',['Diyminipro','DiyminiproMall','BdDiyminipro']],'status'=>1])->order('code desc')->select();
        }
...
//        $this->assign('menu',getMenuList());
    ...
    {
        $is_force = input('param.is_force/d', 1);
