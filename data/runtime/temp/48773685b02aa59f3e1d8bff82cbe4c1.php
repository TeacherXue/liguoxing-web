<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./template/pc/view_article_news.htm";i:1778738925;s:45:"/var/www/html/template/pc/includes/header.htm";i:1778738925;s:45:"/var/www/html/template/pc/includes/footer.htm";i:1778738925;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="keywords" content="valve bag machinery factory, woven sack machinery supplier, direct manufacturer of valve bag machines, block bottom valve bag machine manufacturer, woven bag production line, PP woven bag machine factory">
  <title>Valve Bag Machinery Factory | LIGUOXING</title>
  <meta name="description" content="Read <?php echo $eyou['field']['title']; ?> from LIGUOXING, a valve bag machinery factory and direct manufacturer of woven sack production equipment.">
  <link rel="canonical" href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/news/<?php echo $eyou['field']['htmlfilename']; ?>.htm">
...
<body>
  ...
  <section class="page-hero detail-hero">
    <div class="container">
      ...
      <?php if(!(empty($eyou['field']['subtitle']) || (($eyou['field']['subtitle'] instanceof \think\Collection || $eyou['field']['subtitle'] instanceof \think\Paginator ) && $eyou['field']['subtitle']->isEmpty()))): ?>
      <p class="detail-hero-subtitle"><?php echo $eyou['field']['subtitle']; ?></p>
      <?php else: ?>
      <p class="detail-hero-summary"><?php echo $eyou['field']['seo_description']; ?></p>
      <?php endif; ?>
    </div>
  </section>
    ...
    <div class="container detail-layout">
      <article class="detail-article news-detail-article">
        <div class="detail-meta">
          ...
          <time datetime="<?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?>"><?php echo MyDate('M d, Y',$eyou['field']['add_time']); ?></time>
        </div>
        <?php if(!(empty($eyou['field']['litpic']) || (($eyou['field']['litpic'] instanceof \think\Collection || $eyou['field']['litpic'] instanceof \think\Paginator ) && $eyou['field']['litpic']->isEmpty()))): ?>
        <figure class="detail-image">
          <img src="<?php echo $eyou['field']['litpic']; ?>" alt="<?php echo $eyou['field']['title']; ?>">
        </figure>
        <?php endif; ?>
      ...
      <aside class="detail-aside">
        <div class="detail-side-card dark-side-card">
          <h3>News Update</h3>
          <p><?php echo MyDate('M d, Y',$eyou['field']['add_time']); ?></p>
          <p>LIGUOXING technical, delivery, application, and service updates.</p>
        </div>
        <div class="detail-side-card related-list">
          <h3>More News</h3>
          <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "1"; endif; if(isset($ui_modelid) && !empty($ui_modelid)) : $modelid = $ui_modelid; else: $modelid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 4; endif; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'typeid' => '1',
  'row' => '4',
  'orderby' => 'add_time',
  'ordermode' => 'desc',
          ...
          <a href="/news/<?php echo $field['htmlfilename']; ?>.htm"><?php echo $field['title']; ?></a>
          <?php endif; ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
        </div>
        <div class="detail-side-card news-inquiry-card">
          <h3>Business Inquiry</h3>
          <p><strong>Email:</strong> <a class="text-link" href="mailto:leo@liguoxing.com">leo@liguoxing.com</a></p>
          <p><strong>WhatsApp:</strong> <a class="text-link" href="https://wa.me/8618561683175" target="_blank" rel="noopener">+86 185 6168 3175</a></p>
          <div class="contact-socials" aria-label="Social links">
            <a href="https://www.instagram.com/leo910508?igsh=NGg0bjN1d3ZudGQ4&amp;utm_source=qr" target="_blank" rel="noopener" aria-label="Instagram"><img src="/images/social-instagram.svg" alt="Instagram"></a>
            <a href="https://youtube.com/@valvebagequipment?si=iIgk3m1Kx0meyBVe" target="_blank" rel="noopener" aria-label="YouTube"><img src="/images/social-youtube.svg" alt="YouTube"></a>
            <a href="https://www.facebook.com/share/1CnmhxTrnF/?mibextid=wwXIfr" target="_blank" rel="noopener" aria-label="Facebook"><img src="/images/social-facebook.svg" alt="Facebook"></a>
            <a href="https://wa.me/8618561683175" target="_blank" rel="noopener" aria-label="WhatsApp"><img src="/images/social-whatsapp.svg" alt="WhatsApp"></a>
          </div>
        </div>
        <a class="btn btn-primary detail-cta-button" href="/news.htm">Back to News <b>-></b></a>
      </aside>
    </div>
  </main>
