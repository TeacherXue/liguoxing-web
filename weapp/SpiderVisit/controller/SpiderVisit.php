...
class SpiderVisit extends Weapp
{
    ...
    public function index()
    {
        ...
        $weapp_data = Db::name('weapp')->where(['code'=>'SpiderVisit'])->value('data');
        $weapp_data = json_decode($weapp_data, true);
        if (!isset($weapp_data['spiders'])) {
            $weapp_data['spiders'] = array_keys($this->spiderTypes);
        }
        foreach ($this->spiderTypes as $key => $val) {
            if (!in_array($key, $weapp_data['spiders'])) {
                unset($this->spiderTypes[$key]);
            }
        }
        $this->assign('spiderTypes', $this->spiderTypes);
    ...
    public function tongji()
    {
        ...
        $spider_data = Db::name('weapp_spider_tongji')->where(['spider'=>['IN', $weapp_data['spiders']]])->getAllWithIndex('spider');
        $this->assign('spider_data', $spider_data);
