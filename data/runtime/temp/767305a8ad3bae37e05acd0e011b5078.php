<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:36:"./template/pc/view_article_video.htm";i:1778738925;s:45:"/var/www/html/template/pc/includes/header.htm";i:1778738925;s:45:"/var/www/html/template/pc/includes/footer.htm";i:1778738925;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <meta name="description" content="Watch <?php echo $eyou['field']['title']; ?> from LIGUOXING, a source factory for valve bag machines and woven sack production lines.">
  <link rel="canonical" href="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_basehost"); echo $__VALUE__; ?>/video/<?php echo $eyou['field']['htmlfilename']; ?>.htm">
  ...
  <main class="content-wrap detail-wrap">
    <div class="container detail-layout">
      <article class="detail-article news-detail-article">
        ...
        <button class="video-preview detail-video-preview" type="button" data-video-trigger data-video-src="<?php echo $eyou['field']['youtube_url']; ?>" data-video-title="<?php echo $eyou['field']['title']; ?>" aria-label="Play <?php echo $eyou['field']['title']; ?>">
      ...
      <aside class="detail-aside">
        <div class="detail-side-card dark-side-card">
          ...
          <p>Equipment demos, company introductions, and project presentation clips.</p>
        </div>
        <div class="detail-side-card related-list">
          <h3>More Videos</h3>
          <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "4"; endif; if(isset($ui_modelid) && !empty($ui_modelid)) : $modelid = $ui_modelid; else: $modelid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 4; endif; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'typeid' => '4',
  'row' => '4',
  'orderby' => 'add_time',
  'ordermode' => 'desc',
          ...
          <a href="/video/<?php echo $field['htmlfilename']; ?>.htm"><?php echo $field['title']; ?></a>
          <?php endif; ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
        </div>
        <a class="btn btn-primary detail-cta-button" href="/video.htm">Back to Video <b>-></b></a>
      </aside>
    </div>
  </main>
